...
public class MaximumIntervalBetweenAwardsCalculator implements AwardIntervalCalculator {

    public PairOfMovies maximumIntervalBetweenAwards(List<Movie> movies) {
    ...
    public PairOfMovies calculate(List<Movie> movies) {
        return maximumIntervalBetweenAwards(movies);
    }
}
